...
<div class="row">
    <div class="col-xl-4 col-lg-5">
        <div class="card text-center">
            <div class="card-body">
                <img src="<?= session('user')[0]['foto'] !== '' ? session('user')[0]['foto'] : asset('assets') . "/images/users/avatar-1.jpg" ?>" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">

                <h4 class="mb-1 mt-2"><?= session('user')[0]['nama'] ?></h4>
                <p class="text-muted"><?= session('user')[0]['id_role'] == '1' ? 'Admin' : (session('user')[0]['id_role'] == '2' ? 'Dosen' : 'Mahasiswa') ?></p>


                <div class="text-start mt-3">

                    <p class="text-muted mb-2"><strong>Nama :</strong> <span class="ms-2"><?= session('user')[0]['nama'] ?></span></p>

                    <p class="text-muted mb-2"><strong>NIM :</strong><span class="ms-2"><?= session('user')[0]['nrp'] ?? "-" ?></span></p>

                    <p class="text-muted mb-2"><strong>Prodi :</strong> <span class="ms-2 "><?= session('user')[0]['prodi'] ?? "-" ?></span></p>

                    <p class="text-muted mb-2"><strong>Email :</strong> <span class="ms-2 "><?= session('user')[0]['email'] ?></span></p>
